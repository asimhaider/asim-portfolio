  ...
  return (
    <section id="resume" aria-labelledby="resume-heading" className="bg-white py-20 sm:py-24">
      <div className="container-page">
        <Reveal className="relative overflow-hidden rounded-3xl bg-ink px-6 py-12 text-neutral-300 shadow-hard-brand sm:px-12 sm:py-14">
          <div className="bg-grid-dark pointer-events-none absolute inset-0 [mask-image:linear-gradient(to_left,black,transparent_70%)]" />
          ...
          <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div className="max-w-xl">
              ...
              <h2 id="resume-heading" className="mt-5 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                Want the <span className="text-brand">complete picture?</span>
              </h2>
            ...
            <div className="flex flex-col gap-3 sm:flex-row md:flex-col lg:flex-row">
              ...
              <ButtonLink href={profile.resumeUrl} target="_blank" rel="noopener noreferrer" variant="outlineLight" size="lg">
                View Resume
              </ButtonLink>
            </div>
          </div>
